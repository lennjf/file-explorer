...
import {createFile, createDirectory, deleteFile, renameFile, showWE} from "../../ipc";
...
export default function ContextMenus() {
    ...
    async function openWE() {
        console.log(directoryEntityPayload.filePath.toString);
        await showWE(directoryEntityPayload.filePath);
        window.open("file:///"+directoryEntityPayload.filePath,"_blank");
    }
        ...
        <>
            {currentContextMenu == ContextMenuType.General ? (
                ...
                <ContextMenu options={[
                    ...
                    { name: "open in windows explorer", onClick: async () => openWE()}
                ]} />
            ) : ""}
